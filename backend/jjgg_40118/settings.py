"""
Django settings for jjgg_40118 project.
...
WSGI_APPLICATION = 'jjgg_40118.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jjgg_40118 API",
    "DESCRIPTION": "API documentation for jjgg_40118 App",
    "VERSION": "v1",
}
